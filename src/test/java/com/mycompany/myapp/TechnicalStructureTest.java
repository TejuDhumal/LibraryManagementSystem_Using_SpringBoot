...
@AnalyzeClasses(packagesOf = LibraryManagementApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(LibraryManagementApp.class), alwaysTrue())
